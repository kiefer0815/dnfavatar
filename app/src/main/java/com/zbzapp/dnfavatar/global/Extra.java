package com.zbzapp.dnfavatar.global;
...
public class Extra {
    ...
    public static final String EXTRA_IS_URL = "cimoc.intent.extra.EXTRA_IS_URL";
    public static final String EXTRA_IS_VIDEO = "cimoc.intent.extra.EXTRA_IS_VIDEO";
    public static final String EXTRA_IS_IMAGE = "cimoc.intent.extra.EXTRA_IS_IMAGE";
