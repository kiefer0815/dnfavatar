...
import com.zbzapp.dnfavatar.presenter.MainPresenter;
import com.zbzapp.dnfavatar.ui.fragment.BaseFragment;
import com.zbzapp.dnfavatar.ui.fragment.ComicFragment;
import com.zbzapp.dnfavatar.ui.fragment.dialog.MessageDialogFragment;
import com.zbzapp.dnfavatar.ui.fragment.recyclerview.SourceFragment;
import com.zbzapp.dnfavatar.ui.fragment.recyclerview.TagFragment;
import com.zbzapp.dnfavatar.ui.view.MainView;
 ...
 */
public class OldMainActivity extends BaseActivity implements MainView, NavigationView.OnNavigationItemSelectedListener {
        ...
        mLastText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mPresenter.checkLocal(mLastId)) {
                    Intent intent = TaskActivity.createIntent(OldMainActivity.this, mLastId);
                    startActivity(intent);
                } else if (mLastSource != -1 && mLastCid != null) {
                    Intent intent = DetailActivity.createIntent(OldMainActivity.this, null, mLastSource, mLastCid);
                    startActivity(intent);
                } else {
                    HintUtils.showToast(OldMainActivity.this, R.string.common_execute_fail);
                }
            }
        });
        ...
        if (itemId != mCheckItem) {
            switch (itemId) {
                ...
                case R.id.drawer_settings:
                    startActivityForResult(new Intent(OldMainActivity.this, SettingsActivity.class), REQUEST_ACTIVITY_SETTINGS);
                    break;
                case R.id.drawer_about:
                    startActivity(new Intent(OldMainActivity.this, AboutActivity.class));
                    break;
                case R.id.drawer_backup:
                    startActivity(new Intent(OldMainActivity.this, BackupActivity.class));
                    break;
            }
        }
        return true;
