package com.zbzapp.dnfavatar.component;
...
public class H5LoadingWebView extends WebView {
        ...
        private void initView(Context context) {
                ...
                getSettings().setPluginState(WebSettings.PluginState.ON);//设置webview支持插件
                ...
                Drawable drawable = context.getResources().getDrawable(R.drawable.bg_pb_web_loading);
