...
import com.zbzapp.dnfavatar.source.DM5;
import com.zbzapp.dnfavatar.source.HHSSEE;
import com.zbzapp.dnfavatar.source.IKanman;
...
public interface Parser {
     ...
     * @param page 页码
     */
    Request getCategoryRequest(String format, int page,Headers headers);
